...
[![CircleCI](https://dl.circleci.com/status-badge/img/gh/ministryofjustice/laa-crime-hardship/tree/main.svg?style=shield)](https://dl.circleci.com/status-badge/redirect/gh/ministryofjustice/laa-crime-hardship/tree/main)
...
```sh
git clone git@github.com:ministryofjustice/laa-crime-hardship.git
...
We have configured a CircleCI code pipelines. You can [log in](https://app.circleci.com/pipelines/github/ministryofjustice/laa-crime-hardship) from here to access the pipeline.
